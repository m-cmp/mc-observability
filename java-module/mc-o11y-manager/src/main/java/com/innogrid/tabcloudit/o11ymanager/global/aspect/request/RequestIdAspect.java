...
public class RequestIdAspect {
    ...
    @Around("execution(* com.innogrid.tabcloudit.o11ymanager.controller..*.*(..)) && !within(com.innogrid.tabcloudit.o11ymanager.controller.HostWebSocketController)")
    ...
    @Before("execution(* com.innogrid.tabcloudit.o11ymanager.controller..*.*(..)) && !within(com.innogrid.tabcloudit.o11ymanager.controller.HostWebSocketController)")
