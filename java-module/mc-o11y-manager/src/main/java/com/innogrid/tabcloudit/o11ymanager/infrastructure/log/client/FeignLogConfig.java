...
public class FeignLogConfig {
    ...
    /**
     * Feign 클라이언트의 로깅 레벨을 설정합니다.
     * NONE: 로깅하지 않음
     * BASIC: 요청 메서드와 URL, 응답 상태 코드, 실행 시간만 로깅
     * HEADERS: BASIC에 요청 및 응답 헤더를 추가하여 로깅
     * FULL: 요청 및 응답의 헤더, 본문, 메타데이터를 모두 로깅
     */
    @Bean
