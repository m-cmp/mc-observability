package com.mcmp.o11ymanager.oldFacade;
...
import com.mcmp.o11ymanager.facade.OldSchedulerFacadeService;
...
public class OldTelegrafFacadeService {
  ...
  public void install(@NotBlank String hostId, @NotBlank String requestUserId,
    ...
    try {
      ...
      oldTelegrafConfigFacadeService.initTelegrafConfig(hostConnectionInfo, hostDTO.getType(),
