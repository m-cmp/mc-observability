...
import com.mcmp.o11ymanager.infrastructure.insight.InsightClient;
...
public class InsightController {
  ...
  public Object predictMetric(@PathVariable String nsId, @PathVariable String targetId,
  ...
  public Object getPredictionHistory(@PathVariable String nsId, @PathVariable String targetId,
      @RequestParam String measurement, @RequestParam(required = false) String start_time,
  ...
  public Object updateAnomalyDetectionSetting(@PathVariable Long settingSeq,
      @RequestBody Object body) {
  ...
  public Object getAnomalyDetectionHistory(@PathVariable String nsId, @PathVariable String targetId,
      @RequestParam String measurement, @RequestParam(required = false) String start_time,
      @RequestParam(required = false) String end_time) {
    return insightClient.getAnomalyDetectionHistory(nsId, targetId, measurement, start_time,
        end_time);
  }
