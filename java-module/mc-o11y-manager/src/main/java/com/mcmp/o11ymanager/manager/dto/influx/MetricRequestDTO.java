...
public class MetricRequestDTO {
  ...
  @Schema(description = "List of fields to query", example = "[{\"function\":\"mean\",\"field\":\"usage_idle\"}]")
  @JsonProperty("fields")
  private List<FieldInfo> fields;

  @Schema(description = "List of condition filters", example = "[{\"key\":\"cpu\",\"value\":\"cpu-total\"}]")
