...
import com.mcmp.o11ymanager.facade.AgentFacadeService;
import com.mcmp.o11ymanager.facade.FileFacadeService;
import com.mcmp.o11ymanager.facade.FluentBitConfigFacadeService;
import com.mcmp.o11ymanager.facade.FluentBitFacadeService;
...
public class HostAgentController {
  ...
  private final OldTelegrafConfigFacadeService telegrafConfigService;
  ...
  public ResponseEntity<SuccessResponse<List<ResultDTO>>> enableTelegraf(
    ...
    List<ResultDTO> result =
        oldTelegrafFacadeService.enable(request.getHost_id_list(), requestUserId);
  ...
  public ResponseEntity<SuccessResponse<List<ResultDTO>>> disableTelegraf(
    ...
    List<ResultDTO> result =
        oldTelegrafFacadeService.disable(request.getHost_id_list(), requestUserId);
  ...
  public ResponseEntity<SuccessResponse<List<ResultDTO>>> restartTelegraf(
    ...
    List<ResultDTO> result =
        oldTelegrafFacadeService.restart(request.getHost_id_list(), requestUserId);
