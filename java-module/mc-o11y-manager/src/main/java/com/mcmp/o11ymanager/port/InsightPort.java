...
public interface InsightPort {
  ...
  Object getPredictionHistory(String nsId, String targetId, String measurement, String startTime, String endTime);
  ...
  Object getAnomalyDetectionHistory(String nsId, String targetId, String measurement, String startTime, String endTime);
}
