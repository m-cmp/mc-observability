package com.mcmp.o11ymanager.infrastructure.insight;

import com.mcmp.o11ymanager.port.InsightPort;
...
public class InsightClientAdapter implements InsightPort {
  ...
  @Override
  public Object getPredictionHistory(String nsId, String targetId, String measurement, String startTime, String endTime) {
  ...
  @Override
  public Object getAnomalyDetectionHistory(String nsId, String targetId, String measurement, String startTime, String endTime) {
    return insightClient.getAnomalyDetectionHistory(nsId, targetId, measurement, startTime, endTime);
  }
}