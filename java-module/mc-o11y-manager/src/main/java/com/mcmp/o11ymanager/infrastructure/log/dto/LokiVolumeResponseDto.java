package com.mcmp.o11ymanager.infrastructure.log.dto;
...
@NoArgsConstructor
@AllArgsConstructor
public class LokiVolumeResponseDto {
    private String status;
    private VolumeDataDto data;
    ...
    public static class VolumeDataDto {
        ...
        private List<VolumeResultDto> result;
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class VolumeResultDto {
