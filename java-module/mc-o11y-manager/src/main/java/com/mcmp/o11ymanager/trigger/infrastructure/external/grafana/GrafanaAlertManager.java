...
//            dto.namespaceId() + "-" + dto.vmScope() + "-" + dto.vmId(),
  ...
  /**
   * Tests alert receiver configuration by sending test notifications. Retrieves all contact points
   * and creates test configuration to verify notification delivery.
   *
