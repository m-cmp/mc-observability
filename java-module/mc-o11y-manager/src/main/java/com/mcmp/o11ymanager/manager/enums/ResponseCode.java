...
public enum ResponseCode {
    ...
    VM_CONNECTION_FAILED(
            HttpStatus.INTERNAL_SERVER_ERROR, "Unable to connect to the virtual machine."),
    TELEGRAF_CONFIG_NOT_FOUND(
            HttpStatus.INTERNAL_SERVER_ERROR, "Telegraf configuration not found.");
