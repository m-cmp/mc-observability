...
public interface TargetService {
    ...
    void isIdleMonitoringAgent(String nsId, String mciId, String targetId)
            throws HostAgentTaskProcessingException;

    void isIdleLogAgent(String nsId, String mciId, String targetId)
            throws HostAgentTaskProcessingException;

    void isLogAgentInstalled(String nsId, String mciId, String targetId)
            throws LogAgentNotInstalled;

    void isMonitoringAgentInstalled(String nsId, String mciId, String targetId)
