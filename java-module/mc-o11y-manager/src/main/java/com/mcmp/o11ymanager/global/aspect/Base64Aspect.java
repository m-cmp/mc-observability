package com.mcmp.o11ymanager.global.aspect;
...
public class Base64Aspect {
    ...
    @Before("@annotation(com.mcmp.o11ymanager.global.annotation.Base64Decode)")
    ...
    @AfterReturning(value = "@annotation(com.mcmp.o11ymanager.global.annotation.Base64Encode)",
            returning = "response")
