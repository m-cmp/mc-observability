...
public class RequestIdAspect {
    ...
    @Around("execution(* com.mcmp.o11ymanager.controller..*.*(..)) && !within(com.mcmp.o11ymanager.controller.HostWebSocketController)")
    ...
    @Before("execution(* com.mcmp.o11ymanager.controller..*.*(..)) && !within(com.mcmp.o11ymanager.controller.HostWebSocketController)")
