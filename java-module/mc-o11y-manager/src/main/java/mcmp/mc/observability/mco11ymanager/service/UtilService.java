...
public class UtilService {
    ...
    public Map<String, Object> checkApiHealth() {
        ...
        Map<String, Object> agentManagerStatus = checkExternalServiceHealth(agentManagerURL);
        Map<String, Object> tumblebugStatus = checkExternalServiceHealth(tumblebugURL, tumblebugID, tumblebugPW);
        Map<String, Object> insightStatus = checkExternalServiceHealth(insightURL);
        ...
        if (isApiHealthy) {
            ...
            if (!isAgentManagerHealthy) {
                message.append("Agent Manager is down. ");
            }
            ...
            apiHealthStatus.put("message", message.toString());
        }
