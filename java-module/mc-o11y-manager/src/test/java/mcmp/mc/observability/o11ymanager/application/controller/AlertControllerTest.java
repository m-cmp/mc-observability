...
import com.mcmp.o11ymanager.trigger.application.controller.AlertController;
...
class AlertControllerTest {
    ...
    void checkGrafanaHealth() throws Exception {
        GrafanaHealthCheckResponse healthResponse =
                GrafanaHealthCheckResponse.builder()
                        ...
                        .ruleGroup(new HealthStatus(true))
                        .org(new HealthStatus(true))
                        .build();

        when(alertManager.checkGrafanaHealth()).thenReturn(healthResponse);

        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/alert/health"))
                ...
                .andDo(
                        ApiDocumentation.builder()
                                ...
                                .responseFields(
                                        ...
                                        fieldBoolean(
                                                "ruleGroup.hasData",
                                                "rule group is set up correctly"),
    ...
    void getAllAlerts() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/alert/alerts"))
                .andExpect(status().isOk())
                .andDo(
                        ApiDocumentation.builder()
                                .tag(TAG)
    ...
    void getAlertByTitle() throws Exception {
        ...
        mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/v1/alert/alerts/search")
    ...
    void getAllAlertRules() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/alert/alert-rules"))
                .andExpect(status().isOk())
                .andDo(
                        ApiDocumentation.builder()
                                .tag(TAG)
    ...
    void getAllContactPoints() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/alert/contact-points"))
                .andExpect(status().isOk())
                .andDo(
                        ApiDocumentation.builder()
                                .tag(TAG)
    ...
    void testAlertReceiver() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/alert/alert-receiver/test"))
                .andExpect(status().isOk())
                .andDo(
                        ApiDocumentation.builder()
                                .tag(TAG)
    ...
    void getAlertTestHistories() throws Exception {
        ...
        mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/v1/alert/test-history")
                                .param("page", "1")
                                .param("size", "10")
                                .param("sortBy", "id")
