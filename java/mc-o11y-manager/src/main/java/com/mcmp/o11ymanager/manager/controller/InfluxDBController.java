...
public class InfluxDBController {
    ...
    @GetMapping
    @Operation(summary = "GetAllInfluxDB", operationId = "GetAllInfluxDB", description = "Retrieve all InfluxDB servers")
    public ResBody<List<InfluxDTO>> getAllInfluxDB() {
        return new ResBody<>(influxDbFacadeService.getInfluxDbs());
    }

    @GetMapping("/measurement")
    @Operation(summary = "GetMeasurementFields", operationId = "GetMeasurementFields", description = "Retrieve InfluxDB measurements")
    public ResBody<List<FieldDTO>> measurement() {
        return new ResBody<>(influxDbFacadeService.getFields());
    }

    @GetMapping("/tag")
    @Operation(summary = "GetMeasurementTags", operationId = "GetMeasurementTags", description = "Retrieve InfluxDB tags")
    public ResBody<List<TagDTO>> tag() {
        return new ResBody<>(influxDbFacadeService.getTags());
    }

    @PostMapping("/metric/{nsId}/{mciId}")
    @Operation(summary = "GetMetricsByNsIdAndMciId", operationId = "GetMetricsByNsIdAndMciId", description = "Retrieve InfluxDB metrics")
    ...
    @Operation(summary = "GetMetricsByVMId", operationId = "GetMetricsByVMId", description = "Retrieve InfluxDB metrics")
