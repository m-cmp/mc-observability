...
public class ItemController {
    ...
    @GetMapping
    @Operation(summary = "GetMonitoringItems", operationId = "GetMonitoringItems", description = "Retrieve monitoring item list")
    ...
    @PostMapping
    @Operation(summary = "AddMonitoringItem", operationId = "AddMonitoringItem", description = "Add monitoring item")
    ...
    @PutMapping
    @Operation(summary = "UpdateMonitoringItem", operationId = "UpdateMonitoringItem", description = "Update monitoring item")
    ...
    @Operation(summary = "DeleteMonitoringItem", operationId = "DeleteMonitoringItem", description = "Delete monitoring item")
    public ResBody<Void> deleteItem(
            @Parameter(description = "nsId (e.g., ns-1)", example = "ns-1") @PathVariable String nsId,
            @Parameter(description = "mciId (e.g., mci-1)", example = "mci-1") @PathVariable String mciId,
            @Parameter(description = "vmId (e.g., vm-1)", example = "vm-1") @PathVariable String vmId,
            @Parameter(description = "Item Seq (e.g., 1)", example = "1") @PathVariable Long itemSeq) {
