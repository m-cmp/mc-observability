    ...
    "response": {
        "200": {
            ...
            "content": {
                "application/json": {
                    "example": {
                        "data": {"target_types": ["vm", "mci"], "measurements": ["cpu", "mem", "disk", "system"], "prediction_ranges": {"min": "1h", "max": "2160h"}},
                        "rs_code": "200",
                        "rs_msg": "Success",
                    }
                }
                ...
                "application/json": {
                    "example": {
                        "data": [
                            ...
                            {"plugin_seq": 2, "measurement": "disk", "fields": [{"field_key": "used_percent", "unit": "percent"}]},
                            {"plugin_seq": 4, "measurement": "mem", "fields": [{"field_key": "used_percent", "unit": "percent"}]},
                            {"plugin_seq": 8, "measurement": "system", "fields": [{"field_key": "load1", "unit": "percent"}]},
                        ],
                        "rs_code": "200",
                        "rs_msg": "Success",
                    }
