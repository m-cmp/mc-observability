...
post_prediction_mci_description = {
    "api_description": "Predict future metrics (cpu, mem, disk, system) for a given mci group.",
    "response": {
        "200": {
...
post_prediction_vm_description = {
    "api_description": "Predict future metrics (cpu, mem, disk, system) for a given vm.",
    "response": {
        "200": {
            "description": "Successful prediction response",
            "content": {
...
get_history_mci_description = {
    "api_description": "Get previously stored prediction data for a specific mci group.",
    "response": {
        "200": {
...
get_history_vm_description = {
    "api_description": "Get previously stored prediction data for a specific vm.",
    "response": {
        "200": {
            "description": "Successfully retrieved prediction history",
            "content": {
