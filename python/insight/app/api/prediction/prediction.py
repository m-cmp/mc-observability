...
from app.api.prediction.request.req import (
    GetHistoryMCIPath,
    GetHistoryVMPath,
    GetMeasurementPath,
...
from app.api.prediction.response.res import (
    PredictionMCIHistory,
    PredictionMCIResult,
    PredictionOptions,
    PredictionVMHistory,
    PredictionVMResult,
    ResBodyPredictionMCIHistory,
    ResBodyPredictionMCIResult,
    ResBodyPredictionMeasurement,
    ResBodyPredictionOptions,
    ResBodyPredictionSpecificMeasurement,
    ResBodyPredictionVMHistory,
    ResBodyPredictionVMResult,
)
...
async def get_prediction_mci_history(
    path_params: GetHistoryMCIPath = Depends(), query_params: GetPredictionHistoryQuery = Depends()
):
    prediction_service = PredictionService()
...
async def get_prediction_vm_history(
    path_params: GetHistoryVMPath = Depends(), query_params: GetPredictionHistoryQuery = Depends()
):
    prediction_service = PredictionService()
    result_dict = prediction_service.get_prediction_history(path_params, query_params)
